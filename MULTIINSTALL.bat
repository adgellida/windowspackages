...
rem OS & Utilities
cinst ccleaner teamviewer notepadplusplus.install peazip classic-shell clover
rem winrar silverlight
...
cinst sumatrapdf.install libreoffice
